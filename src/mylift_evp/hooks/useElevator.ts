// THIS FILE COPIED FROM "bowser-elevators-site" Next.js Project AT DATE 02.07.2026 & TIME 20:42 !!!

// AFTER MAKING CHANGES TO this "useElevator" hook in the original "bowser-elevators-site" project
// update this file to synchronise it with original site;
...
// type ElevatorDirections added ONLY IN THIS PROJECT
export type ElevatorDirections = "UP" | "DOWN" | "NONE";

const CallPriorities = { high: 1, medium: 2, low: 3 };

export function useElevator(floor: number, elevatorData: any, controlData: ElevatorControlData) {
